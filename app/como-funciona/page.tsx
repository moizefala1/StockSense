    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden px-6 pb-16 pt-24 lg:px-8 lg:pb-20 lg:pt-32">
          <div className="absolute inset-0 -z-10 bg-gradient-to-b from-accent/8 via-background to-background" />
          <div className="absolute right-0 top-0 -z-10 h-[500px] w-[500px] translate-x-1/3 -translate-y-1/4 rounded-full bg-accent/6 blur-3xl" />
          <div className="absolute bottom-0 left-0 -z-10 h-[400px] w-[400px] -translate-x-1/4 translate-y-1/3 rounded-full bg-primary/4 blur-3xl" />
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <a href="#como-invertir" onClick={(e) => { e.preventDefault(); scrollTo("como-invertir") }}>
                  Aprender más
                </a>
              </Button>
            </div>
        ...
        <section id="como-invertir" className="scroll-mt-24 px-6 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <div
              ...
              data-tutorial-id="investing-definition"
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p
                  ...
                  data-tutorial-id="investment-stock-definition"
                >
        ...
        {/*PROCESO*/}
        <section id="proceso" className="scroll-mt-24 bg-muted/30 px-6 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
        ...
        {/* INDICADORES */}
        <section id="indicadores" className="scroll-mt-24 px-6 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-16 text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
        ...
        <section id="resultados" className="scroll-mt-24 bg-muted/30 px-6 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-16 text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
        ...
        {/* FILOSOFIA  */}
        <section id="filosofia" className="scroll-mt-24 px-6 py-20 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-16 text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                Nuestra filosofía
        ...
        {/* FAQ */}
        <section id="faq" className="scroll-mt-24 bg-muted/30 px-6 py-20 lg:px-8">
